    ...
    <section id="experience">
      ...
      <div className=" container mx-auto 2xl ">
        <div className="flex  flex-row justify-between pt-5">
          <p className="text-gray-300 ">
            <span className="font-semibold">Backend Developer /</span> Software
            Engineer
          </p>
      ...
      <div className=" container mx-auto 2xl ">
        <div className="flex  flex-row justify-between pt-5">
          ...
          <p className="text-gray-300">July 2024 - Present, Noida</p>
        </div>
        <p className="text-gray-300 pt-5">
          Currently, I am working in Holmium Technologies, as a Software
          Developer
          <br />
          <br />
